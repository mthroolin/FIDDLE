...
parser$add_argument('--stats_functions', nargs='+', type="character", default='min max mean')
parser$add_argument('--binarize', type="integer", default='1', nargs='?', const=TRUE)
parser$add_argument('--impute_method', type="character", default='ffill',
                    help="Imputation method. Choices: 'none', 'ffill', 'mean', 'linear', 'median', 'mode'. Default: 'ffill'")

# Parse arguments
args = parser$parse_args()

# Construct command string
cmd = paste0('python -m FIDDLE.run --data_path=', args$data_path, 
